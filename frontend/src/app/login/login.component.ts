...
export class LoginComponent {
  ...
  private token: any;
    ...
    constructor(private _httpWebService: PassengerServiceService,  private router: Router) {
    ...
    validateSignIn() {
        ...
        // end of validation!!!!
      if (this.validateStatus) {
         //this._httpWebService.fetchAllPassenger(this.username, this.password)

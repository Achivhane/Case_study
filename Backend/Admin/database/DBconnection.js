...
const mongodbURL='mongodb+srv://admin:admin@cluster0.lphttf9.mongodb.net/Railways_Admin?retryWrites=true&w=majority'
...
//     }
    var db = mongoose.connect(mongodbURL,{useNewUrlParser: true, useUnifiedTopology:true, useCreateIndex:true }, function(error){
        if(error) console.log("error while db connection in admin",error);
